<template>
  <v-layout justify-center mt-5>
    <v-flex xs12 sm8 md6 xl4>
      <v-card>
        <v-card-text
          class="display-1 text-uppercase primary white--text text-xs-center"
        ...
        <v-card-text>
          ...
          <v-btn block color="info" @click="facebook">
            <v-icon left dark>fab fa-facebook</v-icon>Facebook
          </v-btn>
        </v-card-text>
        <v-card-text>
          ...
          <v-btn
            ...
            v-if="registro"
          >¿Ya tienes tienes cuenta? Ingresa aquí</v-btn>
        </v-card-text>
      </v-card>
    </v-flex>
  </v-layout>
